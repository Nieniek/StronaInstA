        ...
        <div class="row">
            <form action="rejestracja.php" method="POST">
                <div class="mb-3 col-6 offset-3">
                    ...
                    <input class="form-control w-100" type="text" name="name" id="nameInput">
                </div>
                <div class="mb-3 col-6 offset-3">
                    <label class="form-label w-100" for="surenameInput">Nazwisko</label>
                    <input class="form-control w-100" type="text" name="surename" id="surenameInput">
                </div>
                <div class="mb-3 col-6 offset-3">
                ...
                <div class="mb-3 col-6 offset-3">
                    ...
                    <input class="form-control w-100" type="password" name="passwordrepeat"
